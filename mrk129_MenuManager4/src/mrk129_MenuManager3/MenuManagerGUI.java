...
public class MenuManagerGUI {
	...
	public MenuManagerGUI(String dishFile) throws IOException {
	...
	public void panel3() throws IOException {
		...
		deleteButton.addActionListener(event->{
			...
			FileManager.deleteFileContent("data/menus.txt");
		});
	...
	public void detailButton() {
		...
		detailsButton.addActionListener(event->{
			if(listModel.getElementAt(menuListSelector.getSelectedIndex())!= null) {
				menuSelected = listModel.get(menuListSelector.getSelectedIndex());
				JFrame detailFrame = new JFrame(menuSelected.getName());
	...
	public void saveToFile() throws IOException {
		...
		saveButton.addActionListener( event->{
			...
			FileManager.writeMenus("data/menus.txt", menuConvert);
		});
	}
